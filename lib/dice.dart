    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 20,
          child: Text(
            "You have rolled ${activeDiceImage.substring(activeDiceImage.indexOf("-") + 1, activeDiceImage.indexOf("."))}",
        ...
        OutlinedButton(
          onPressed:
              rollDice, // Call the rollDice function when the button is pressed
          style: OutlinedButton.styleFrom(
            padding: const EdgeInsets.all(
                20), // Add padding to the button on all sides
            foregroundColor: Colors.white,
            textStyle: const TextStyle(fontSize: 20),
            backgroundColor: const Color.fromARGB(191, 0, 149, 255),
            side: const BorderSide(
                color: Colors.white, width: 2), // Add a border to the button
          ),
